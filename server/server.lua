...
setmetatable(Translations, {
    __index = function(_, key)
        ...
        if not translation then
            print(string.format(Config.SystemMessages.noTranslation or "No translations for '%s' .", key))
...
-- Sukurkite lentelę, jei jos nėra, ir pridėkite trūkstamuosius įrašus
...
MySQL.ready(function()
    MySQL.Async.fetchAll(SQL.selectAllCount, {}, function(result)
        if result[1].count == 0 then
            ...
            print(Config.SystemMessages.initialDataLoaded or "[Stock Market] Pradiniai duomenys įkelti.")
        end
    end)
end)
            ...
            if item.percentage ~= nil then
                ...
                if percentage == 0 then
                    ...
                    if isPerishable then
                        ...
                        -- Tai tikriausiai numatytoji reikšmė daiktui bez būklės. Naudojam 100%.
